...
export const getProjectMembers = (projectId: string) =>
  createSelector(getProjectsState, getUserEntities, (state: any, entities) => {
...
export const getAuth = createSelector(
  ...
  getUserEntities,
  (auth, entities) => {
    return { ...auth, user: entities[auth.userId] };
  }
);
